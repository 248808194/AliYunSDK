...
import uuid
import json
access_key_id = 'LTAI0uACaz2xLGMP'
access_key_secret = 'BMxBETTkXgZI1kEYTewYSpQx5bUblK'
server_address = 'https://domain.aliyuncs.com'
#定义参数
user_params = {'Action': 'QueryDomainList', 'PageNum':3, "PageSize":1 }
...
def make_request(user_params, quiet=False):
    ...
    try:
        ...
        raise SystemExit(e)
    json.dump(obj, sys.stdout, sort_keys=True, indent=2) #输出
    sys.stdout.write('\n')
